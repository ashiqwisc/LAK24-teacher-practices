...
```
```{r}
unit_cols <- c("dayID", "periodID", "actor", "high_ck_gain")
...
```
```{r}
rotation.para <- list(high_ck_gain=tma_spatial_feature$meta.data$high_ck_gain == 1,
       low_ck_gain=tma_spatial_feature$meta.data$high_ck_gain == 0)
...
plot(tma_spatial_feature_set, title = "Spatial Information as Features:
     Low (red) vs high_ck_gain (blue)") %>%
  units(
    points = tma_spatial_feature_set$points$high_ck_gain$`0`,
    points_color = "red",
    show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
  units(
    points = tma_spatial_feature_set$points$high_ck_gain$`1`,
    points_color = "blue",
    show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
  edges(
    weights = (colMeans(tma_spatial_feature_set$line.weights$high_ck_gain$`0`) - colMeans(tma_spatial_feature_set$line.weights$high_ck_gain$`1`)) ,
...
plot(tma_spatial_feature_set, title = "Spatial Information as Features:
  ...
  edges(
    weights = (colMeans(tma_spatial_feature_set$line.weights$high_ck_gain$`0`)) ,
    # edge_size_multiplier = edge_size_multiplier,
    # edge_arrow_saturation_multiplier = edge_arrow_saturation_multiplier,
   # node_position_multiplier = node_position_multiplier,
    edge_color = c("red")) %>%
...
plot(tma_spatial_feature_set, title = "Spatial Information as Features:
  ...
  edges(
    weights = (colMeans(tma_spatial_feature_set$line.weights$high_ck_gain$`1`)) ,
    # edge_size_multiplier = edge_size_multiplier,
    # edge_arrow_saturation_multiplier = edge_arrow_saturation_multiplier,
   # node_position_multiplier = node_position_multiplier,
    edge_color = c("blue")) %>%
...
```{r}
rotation.para <- list(high_ck_gain=tma_spatial_parameter$meta.data$high_ck_gain == 1,
       low_ck_gain=tma_spatial_parameter$meta.data$high_ck_gain == 0)
...
plot(tma_spatial_parameter_set, title = "Spatial Information as Parameters:
     Low (red) vs high_ck_gain (blue)") %>%
  units(
    points = tma_spatial_parameter_set$points$high_ck_gain$`0`,
    points_color = "red",
    show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
  units(
    points = tma_spatial_parameter_set$points$high_ck_gain$`1`, 
    points_color = "blue",
    show_mean = TRUE, show_points = FALSE, with_ci = TRUE) %>%
  edges(
    weights = (colMeans(tma_spatial_parameter_set$line.weights$high_ck_gain$`0`) - colMeans(tma_spatial_parameter_set$line.weights$high_ck_gain$`1`)) ,
    # edge_size_multiplier = edge_size_multiplier,
    # edge_arrow_saturation_multiplier = edge_arrow_saturation_multiplier,
   # node_position_multiplier = node_position_multiplier,
    edge_color = c("red","blue")) %>%
...
plot(tma_spatial_parameter_set, title = "Spatial Information as Features:
  ...
  edges(
    weights = (colMeans(tma_spatial_parameter_set$line.weights$high_ck_gain$`0`)) ,
    # edge_size_multiplier = edge_size_multiplier,
    # edge_arrow_saturation_multiplier = edge_arrow_saturation_multiplier,
   # node_position_multiplier = node_position_multiplier,
    edge_color = c("red")) %>%
...
plot(tma_spatial_parameter_set, title = "Spatial Information as Features:
  ...
  edges(
    weights = (colMeans(tma_spatial_parameter_set$line.weights$high_ck_gain$`1`)) ,
    # edge_size_multiplier = edge_size_multiplier,
    # edge_arrow_saturation_multiplier = edge_arrow_saturation_multiplier,
   # node_position_multiplier = node_position_multiplier,
    edge_color = c("blue")) %>%
